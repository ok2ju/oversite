...
func (q *Queries) DeleteGameEventsByDemoID(ctx context.Context, demoID uuid.UUID) error {
...
func (q *Queries) GetGameEventsByDemoID(ctx context.Context, demoID uuid.UUID) ([]GameEvent, error) {
