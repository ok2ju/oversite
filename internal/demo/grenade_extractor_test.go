...
func TestExtractEntityID(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "throw extra returns entity id",
			extra: &GrenadeThrowExtra{EntityID: 42},
			want:  42,
		},
		{
			name:  "bounce extra returns entity id",
			extra: &GrenadeBounceExtra{EntityID: 99},
			want:  99,
		},
		{
			name:  "detonate extra returns entity id",
			extra: &GrenadeDetonateExtra{EntityID: 7},
			want:  7,
		},
		{
			name:  "kill extra returns 0 (no entity id)",
			extra: &KillExtra{Headshot: true},
			want:  0,
		},
		{
			name:  "nil extra returns 0",
			extra: nil,
			want:  0,
		},
	}
...
func TestExtractGrenadeLineups_BasicSmoke(t *testing.T) {
	events := []GameEvent{
		...
		},
		{
			...
			AttackerSteamID: "123", Weapon: "Smoke Grenade",
			X: 500, Y: 600, Z: 0,
			ExtraData: &GrenadeDetonateExtra{EntityID: 42},
		},
	}
	...
	events := []GameEvent{
		{
			...
			X: 10, Y: 20, Z: 5,
			ExtraData: &GrenadeThrowExtra{EntityID: 7},
		},
		{
			Tick: 80, RoundNumber: 2, Type: "grenade_detonate",
			AttackerSteamID: "456", Weapon: "HE Grenade",
			X: 300, Y: 400, Z: 10,
			ExtraData: &GrenadeDetonateExtra{EntityID: 7},
		},
	}
	...
	events := []GameEvent{
		{
			...
			X: 50, Y: 60, Z: 0,
			ExtraData: &GrenadeThrowExtra{EntityID: 55},
		},
		{
			Tick: 250, Type: "fire_start",
			AttackerSteamID: "123", Weapon: "Incendiary Grenade",
			X: 300, Y: 400, Z: 0,
			ExtraData: &GrenadeDetonateExtra{EntityID: 55},
		},
	}
	...
	events := []GameEvent{
		{
			...
			X: 10, Y: 20, Z: 0,
			ExtraData: &GrenadeThrowExtra{EntityID: 9},
		},
		{
		...
		},
		{
			...
			AttackerSteamID: "111", Weapon: "Smoke Grenade",
			X: 500, Y: 600, Z: 0,
			ExtraData: &GrenadeDetonateExtra{EntityID: 9},
		},
		{
	...
	events := []GameEvent{
		{
			...
			AttackerSteamID: "123", Weapon: "Smoke Grenade",
			X: 10, Y: 20, Z: 0,
			ExtraData: &GrenadeThrowExtra{EntityID: 77},
		},
...
func TestExtractGrenadeLineups_OrphanedDetonation(t *testing.T) {
	events := []GameEvent{
		// Detonation with no prior throw.
		{
			...
			AttackerSteamID: "123", Weapon: "Smoke Grenade",
			X: 500, Y: 600, Z: 0,
			ExtraData: &GrenadeDetonateExtra{EntityID: 88},
		},
	}
	...
	events := []GameEvent{
		{
			...
			AttackerSteamID: "111", Weapon: "Smoke Grenade",
			X: 10, Y: 20, Z: 0,
			ExtraData: &GrenadeThrowExtra{EntityID: 1},
		},
		{
			Tick: 110, Type: "grenade_throw",
			AttackerSteamID: "111", Weapon: "HE Grenade",
			X: 15, Y: 25, Z: 0,
			ExtraData: &GrenadeThrowExtra{EntityID: 2},
		},
		{
			Tick: 200, Type: "smoke_start",
			AttackerSteamID: "111", Weapon: "Smoke Grenade",
			X: 500, Y: 600, Z: 0,
			ExtraData: &GrenadeDetonateExtra{EntityID: 1},
		},
		{
			Tick: 210, Type: "grenade_detonate",
			AttackerSteamID: "111", Weapon: "HE Grenade",
			X: 300, Y: 350, Z: 0,
			ExtraData: &GrenadeDetonateExtra{EntityID: 2},
		},
	}
...
func TestExtractGrenadeLineups_MissingEntityID(t *testing.T) {
	...
	events := []GameEvent{
		...
		},
		{
			...
			AttackerSteamID: "123", Weapon: "Smoke Grenade",
			X: 500, Y: 600, Z: 0,
			ExtraData: &GrenadeDetonateExtra{EntityID: 0},
		},
	}
